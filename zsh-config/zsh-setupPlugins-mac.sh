...
# Update Homebrew and install required tools
brew update
brew install zsh git curl fzf aws-vault kubectl terraform
...
# Install Powerlevel10k fonts for better prompt rendering
